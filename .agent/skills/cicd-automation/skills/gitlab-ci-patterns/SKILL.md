...
description:
  ...
  scalable automation. Use when implementing GitLab CI/CD, optimizing pipeline performance, or
...
Create efficient GitLab CI pipelines with proper stage organization, caching, and deployment
strategies.
