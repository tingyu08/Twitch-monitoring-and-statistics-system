...
name: internal-comms
description:
  Write internal communications using company formats. Use when writing status reports, leadership
  updates, company newsletters, FAQs, incident reports, project updates, or any internal
  communications.
...
**Date:** [Date] **Author:** [Name] **Status:** 🟢 On Track / 🟡 At Risk / 🔴 Blocked
...
**Severity:** P0/P1/P2/P3 **Duration:** [Start] - [End] **Impact:** [User/revenue impact]
