...
A comprehensive plugin for .NET backend development with C#, ASP.NET Core, Entity Framework Core,
and Dapper.

## Overview

This plugin provides agents, skills, and patterns for building production-grade .NET applications.
It focuses on modern C# (12/13), ASP.NET Core 8+, and enterprise development patterns.
