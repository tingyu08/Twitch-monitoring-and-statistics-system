...
- **As a** 實況主
- **I want** 直接從儀表板建立和管理投票，並能自訂顯示外觀
- **So that** 我能讓觀眾參與決策，並提升直播畫面的質感

**應用與 UI**：

- **OBS Overlay URL**：提供一個專屬網址，可在 OBS 瀏覽器來源顯示透明背景的即時投票結果。
- **自訂樣式**：儀表板可調整投票條顏色、字體、動畫效果 (3D 長條圖/圓餅圖)。

**技術需求**：

- 建立投票（標題、選項、持續時間）
- 查看即時投票結果 (EventSub `channel.poll.progress`)
- 結束投票
- 投票歷史記錄
