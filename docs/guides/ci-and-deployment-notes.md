...
本文件補充 `docs/dev-setup.md` 中的第 5、6 章，提供更具體的最小可行 CI 與部署／遷移注意事項，作為未來 Architect / Dev / Ops 設計正式流程時的起點。
...
- 若未來 CI / 部署流程有重大變動，請同步更新本文件，並在對應的 QA 文檔（Gate / Risk / NFR）中註明版本或依據。  
