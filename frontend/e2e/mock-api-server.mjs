...
const mockLifetimeStats = {
  ...
  lifetimeStats: {
    watchTime: { totalMinutes: 120, totalHours: 2, avgSessionMinutes: 60, firstWatchedAt: '2025-01-01', lastWatchedAt: '2025-01-02' },
    ...
    activity: { activeDaysLast30: 2, activeDaysLast90: 2, mostActiveMonth: '2025-01', mostActiveMonthCount: 2 },
    rankings: { watchTimePercentile: 50, messagePercentile: 50 },
  },
  badges: [],
  radarScores: { watchTime: 20, interaction: 10, loyalty: 10, activity: 10, contribution: 0, community: 0 },
};
