...
| 2.5   | 隱私與授權控制 (GDPR 合規)  | 🚧 進行中 | -          | 細粒度同意設定, 資料匯出, 帳號刪除 (核心功能已實作)     |

**Story 2.5 已實作功能** (2025-12-17):

- **後端**: 5 個新 Prisma models, 3 個服務, 9 個新 API 端點, Cron Job
- **前端**: 隱私設定頁面, 隱私政策頁面, 同意橫幅元件
- **功能**: 10 個細粒度收集開關, JSON/CSV 資料匯出, 7 天冷靜期刪除機制
