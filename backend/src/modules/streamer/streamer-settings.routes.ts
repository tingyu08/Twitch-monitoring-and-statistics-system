...
router.post("/settings", (req, res) => streamerSettingsController.updateSettings(req, res));
...
router.post("/templates", (req, res) => streamerSettingsController.createTemplate(req, res));
